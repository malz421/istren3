		...
		<div class="col-lg-12">
			<div class="box">
				<div class="box-body">
					...
					<a href="<?php echo base_url('all/absen'); ?>" class="btn btn-sm btn-info">
				...
				<div class="box-body">
					<table class="table table-bordered table-striped" style="font-size:14px;" id="example2">
						...
						<tr>
						   ...
						   <th>Konversi Terlambat</th>
						</tr>
						</thead>
						<tbody>
						<?php 
							$no= 0;
							foreach ($dataabsen->result() as $key => $row) { $id = $row->id_absen_umum; 
							$no++;
						?>
						<tr>
							<td>
							...
							<td><?php echo $row->toleransi_lambat; ?></td>
							<td><?php echo $row->konversi_lambat; ?></td>
	...
	<div class="modal-dialog role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h3 class="modal-title" id="myModalLabel">Tambah Absen Umum</h3>
			</div>
			<form class="form-horizontal" method="post" action="<?php echo base_url().'all/absen/tambah_absen_umum'?>" enctype="multipart/form-data">
				...
				<div class="modal-body">
					...
					<div class="form-group">
						<label class="control-label col-sm-4" >Toleransi Keterlambatan</label>
						<div class="col-sm-7">
							<input type='number' name="tolterlambat" class="form-control" type="text">
							<small class="text-danger pl-3">* dalam menit</small>
						</div>
					</div>

					<div class="form-group">
						<label class="control-label col-sm-4" >Konversi Keterlambatan</label>
						<div class="col-sm-7">
							<input  type='number' name="konverterlambat" class="form-control" type="text">
							<small class="text-danger pl-3">* satuan jam (.. jam untuk 1 hari)</small>
						</div>
					</div>
...
?>
<div id="modalEdit<?php echo $a['id_absen_umum']?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
				<h3 class="modal-title" id="myModalLabel">Edit Absen Umum</h3>
			</div>
		
			<form class="form-horizontal" method="post" action="<?php echo base_url().'all/absen/ubah_absen_umum'?>" enctype="multipart/form-data">
				<input type="hidden" name="<?=$this->security->get_csrf_token_name();?>" value="<?=$this->security->get_csrf_hash();?>" style="display: none">
				<div class="modal-body">
				<div class="form-group">
						<input type="hidden" name="idabsenumum" id="idabsenumum" value="<?php echo $a['id_absen_umum']; ?>">
						<label class="control-label col-sm-4">Lembaga</label>
						<div class="col-sm-7">
					...
					<div class="form-group">
						<label class="control-label col-sm-4" >Toleransi Keterlambatan</label>
						<div class="col-sm-7">
							<input type='number' value="<?php echo $a['toleransi_lambat'] ?>"  name="tolterlambat" class="form-control" type="text">
							<small class="text-danger pl-3">* dalam menit</small>
						</div>
					</div>
					...
					<div class="form-group">
						<label class="control-label col-sm-4" >Konversi Keterlambatan</label>
						<div class="col-sm-7">
							<input  type='number' value="<?php echo $a['konversi_lambat'] ?>" name="konverterlambat" class="form-control" type="text">
							<small class="text-danger pl-3">* satuan jam (.. jam untuk 1 hari)</small>
						</div>
					</div>
				</div>
...
foreach ($dataabsen->result_array() as $a) {
?>
<div id="modalLihat<?php echo $a['id_absen_umum']?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
			...
			<form class="form-horizontal" method="post" enctype="multipart/form-data">
				...
				<div class="form-group">
					...
					<div class="form-group">
						<label class="control-label col-sm-4" >Toleransi Keterlambatan</label>
						<div class="col-sm-7">
							<input type='number' value="<?php echo $a['toleransi_lambat'] ?>"  name="tolterlambat" class="form-control" type="text" readonly>
							<small class="text-danger pl-3">* dalam menit</small>
						</div>
					</div>
					...
					<div class="form-group">
						<label class="control-label col-sm-4" >Konversi Keterlambatan</label>
						<div class="col-sm-7">
							<input  type='number' value="<?php echo $a['konversi_lambat'] ?>" name="konverterlambat" class="form-control" type="text" readonly>
							<small class="text-danger pl-3">* satuan jam (.. jam untuk 1 hari)</small>
						</div>
					</div>
				</div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<form class="form-horizontal" method="post" action="<?php echo base_url().'all/absen/hapus_absen_umum'?>">
					<div class="modal-body">
					<p>Yakin mau menghapus data..?</p>
					<input name="idabsenumum" type="hidden" value="<?php echo $id; ?>">
					</div>
					<div class="modal-footer">
