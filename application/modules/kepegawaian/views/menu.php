  ...
  <body>
    ...
    <div class="container">
      ...
      <!-- Main component for a primary marketing message or call to action -->
       ...
       <a href="<?php echo base_url().'psbalmatuq/inputdaftar'?>" data-toggle="modal">
                            <i class="fa fa-wifi"></i>
                                <p style="text-align:center;font-size:24px;padding-left:5px;">Al-BASSAM</p>
                        </a>
      <?php $this->load->view($konten_public); ?>

      <hr>
      <div class="footer">
        <a href="<>" target="_blank">Kode Rumit</a> &copy; <?php echo $web->tahun_web; ?> 
      </div>
    </div> <!-- /container -->
