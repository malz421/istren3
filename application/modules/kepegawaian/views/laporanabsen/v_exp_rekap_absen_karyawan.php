 ...
 <table border="1" width="100%">
	...
	<tbody>
		 ...
		 <tr>
			  ...
			  <td align="center"style="width:100px"><?php echo $data->menit_lebih_masuk;?></td>
			  ...
			  <td align="center"style="width:100px"><?php echo $data->menit_lebih_keluar; ?></td>
...
<tbody>
		 <?php 
			...
			<tr>
				<td colspan="2">
				<div>
				Jumlah Hadir Terlambat:
				</div>
				</td>
				<td>
				<div>
				<?php echo $row->jmlhadirterlambat; ?> 
				</div>
				</td>
				<td>
				<div>
