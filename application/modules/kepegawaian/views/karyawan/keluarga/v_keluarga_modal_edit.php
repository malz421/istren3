...
?>
			...
			<div class="form-group">
				...
				<div class="col-md-7">
					...
					<input type="text" name="tgllhrkel" value="<?php echo rubah_tanggal($tglkel); ?>" class="form-control pull-right" data-date-format="dd-mm-yyyy" id="datepickeluarga" data-provide='datepicker' data-date-container='#modalkeluarga' data-date-autoclose='true'>
