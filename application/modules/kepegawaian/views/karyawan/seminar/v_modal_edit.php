...
<form class="form-horizontal" method="POST" enctype="multipart/form-data" id="formeditseminar">
	...
	<div class="modal-body">
		...
		<input type="hidden" id="idseminar" name="idseminar" value="<?=$idseminar?>"class="form-control">
	...
	<script>
		$('form#formeditseminar').on('submit', function (e) {
			ajaxcsrf();
			...
			$.ajax({
				url: "<?=base_url('kepegawaian/seminar/update')?>",
				type: 'POST',
