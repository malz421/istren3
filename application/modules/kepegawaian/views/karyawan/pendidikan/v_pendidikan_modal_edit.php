...
?>
	...
	<div class="modal-header">
		...
		<div class="callout callout-success" id="myModalLabel">
         <h4>UBAH DATA PENDIDIKAN</h4>
        </div>
	</div>
	<form class="form-horizontal"  enctype="multipart/form-data" id="formeditpendidikan">
		<input type="hidden" name="method" value="add"/>
		<input type="hidden" name="<?=$this->security->get_csrf_token_name();?>" value="<?=$this->security->get_csrf_hash();?>" style="display: none">
		<div class="modal-body">
		    <input type="hidden" id="idsekolah" name="idsekolah" value="<?=$idsekolah?>" class="form-control">
...
?>
			...
			<div class="form-group">
				...
				<div class="col-sm-7">
					<input id="jurusan"  name="jurusan" class="form-control" type="text" placeholder="Input Jurusan Gelar " value="<?=$jurusan?>">
		...
		<div class="modal-footer">
			...
			<button id="submit1" type="submit" class="btn btn-info">Simpan</button>
		</div>
	</form>
<?php
...
<script>
$('form#formeditpendidikan').on('submit', function (e) {
	    ajaxcsrf();
        ...
        $.ajax({
            url: "<?=base_url('kepegawaian/Pendidikan/update_pendidikan')?>",
            data: $(this).serialize(),
            type: 'POST',
