...
<!-- Page Heading -->
	...
	<div class="row">
		<div class="col-lg-12">
          ...
          <a href="<?php echo base_url('kepegawaian/Absen_shift/TambahAbsenShift'); ?>" class="btn btn-sm btn-success">
				<span class="fa fa-plus"></span> Tambah Absen Shift</a>
   ...
   <div class="row">
		<div class="col-lg-6">
			<form class="form-horizontal" id="reloadshift" method="post" enctype="multipart/form-data" >
				...
				<div class="box box-success">
						...
						<div class="form-group">
									...
									<div class="col-sm-6">
										<select class="form-control select2" name="idabsenshift" id="idabsenshift" style="width: 100%;" required>
											...
											?> 
												<option value="<?php echo $row->kode_shift; ?>"><?php echo $row->nama_shift .' | '. $row->jam_masuk .'-'. $row->jam_keluar; ?></option>
											<?php
												$no++;}
											?>
										</select>
					...
					<div class="box-footer">
						<button onclick="reload_shift()" id="submit" class="btn btn-sm btn-info" type="button"><i class="fa fa-search"></i> Cari</button>
						<span  onclick="reload_ajax()"  class="btn btn-sm btn-success"><i class="fa fa-print" aria-hidden="true"></i> Unduh Template</span>
						<span  onclick="reload_ajax()"  class="btn btn-sm btn-success"><i class="fa fa-print" aria-hidden="true"></i> Import Data Shift</span>
					</div>
				</div>
			</form>
		</div>
...
<!--DATA SHIFT-->
<div class="datashift" id="datashift"></div>
