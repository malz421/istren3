...
<head>
  ...
  <!-- Font Awesome -->
  <link href="<?php echo base_url('adminlte/font-awesome/css/font-awesome.min.css') ?>" rel="stylesheet" type="text/css" />
  <!-- Ionicons -->
  <link href="<?php echo base_url('adminlte/ionicons/css/ionicons.min.css') ?>" rel="stylesheet" type="text/css" />
  <!-- jvectormap -->
  ...
  <!-- Morris chart -->
  <link href="<?php echo base_url('adminlte/morris.js/morris.css') ?>" rel="stylesheet" type="text/css" />
  <!-- Date Picker -->
  <link href="<?php echo base_url('adminlte/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css') ?>" rel="stylesheet" type="text/css" />
  <!-- Daterange picker -->
  <link href="<?php echo base_url('adminlte/bootstrap-daterangepicker/daterangepicker.css') ?>" rel="stylesheet" type="text/css" />
...
<!-- jQuery 2.2.3 -->
<script src="<?php echo base_url('adminlte/jquery/dist/jquery.min.js') ?>"></script>
<!-- Bootstrap 3.3.6 -->
<script src="<?php echo base_url('adminlte/bootstrap/js/bootstrap.min.js') ?>"></script>
<!-- Morris.js charts -->
<script src="<?php echo base_url('adminlte/raphael/raphael.min.js') ?>"></script>
<script src="<?php echo base_url('adminlte/morris.js/morris.min.js') ?>"></script>
<!-- FastClick -->
<script src="<?php echo base_url('adminlte/fastclick/lib/fastclick.js') ?>"></script>
<script src="bower_components/fastclick/lib/fastclick.js"></script>
<!-- AdminLTE App -->
