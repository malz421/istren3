<header class="main-header">
     <!-- Logo -->
    <a href="<?php echo base_url('all/dmin_page') ?>" class="logo">
        ...
        <ul class="nav navbar-nav">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?php echo base_url().'all/pengguna/edit_profile/'.$this->session->userdata('id'); ?>" class="btn btn-default btn-flat">Profile</a>
