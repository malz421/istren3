...
<html lang="en">
<head>
	<title>SIP-SISTEM INFORMASI PESANTREN</title>
    <meta charset="utf-8">
...
<body>
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('<?php echo base_url('assets/images/bg.jpg'); ?>');">
			<div class="wrap-login100 p-t-100 p-b-30">
				<form action="<?php echo base_url('all/login/cek_user')?>" method="post" class="login100-form validate-form">
					...
					<div class="wrap-input100 validate-input m-b-10">
						<input class="input100" type="password" name="password" placeholder="Password / PIN"  required>
						<span class="focus-input100"></span>
						<span class="symbol-input100">
    ...
    <script src="<?php echo base_url('login/vendor/bootstrap/js/bootstrap.min.js'); ?>"></script></script>
